...
-(void) documentViewController:(MFDocumentViewController *)dvc didReceiveTapAtPoint:(CGPoint)point {
	...
	if(!waitingForTextInput) {
		...
		if(hudHidden) {
                ...
                [bookmarksButton setHidden:NO];
                [outlineButton setHidden:NO];
                [searchButton setHidden:NO];
                [pageLabel setHidden:NO];
                [pageSlider setHidden:NO];
                ...
                [bookmarksButton setHidden:YES];
                [outlineButton setHidden:YES];
                [searchButton setHidden:YES];
                [pageLabel setHidden:YES];
                [pageSlider setHidden:YES];
...
- (void)viewDidLoad {
	...
	*/
    ...
    [aButton setFrame:CGRectMake(viewSize.width-side_b-w, viewSize.height-bot_b,w,h)];
    im = [UIImage imageNamed:@"Search_Button.png"];
    [aButton setImage:im forState:UIControlStateNormal];
    [aButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
    ...
    aButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [aButton setFrame:CGRectMake(side_b,top_b,w,h)];
    im = [UIImage imageNamed:@"backArrow_button.png"];
    [aButton setImage:im forState:UIControlStateNormal];
    [aButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
    [aButton setAutoresizingMask:UIViewAutoresizingFlexibleBottomMargin|UIViewAutoresizingFlexibleRightMargin];
    ...
    CGFloat offset = 1;
    aButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [aButton setFrame:CGRectMake(floorf(viewSize.width/2-w/2), viewSize.height-bot_b-offset,w,h)];
    im = [UIImage imageNamed:@"Bookmark_Button.png"];
    [aButton setImage:im forState:UIControlStateNormal];
    [aButton setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
    [aButton setAutoresizingMask:UIViewAutoresizingFlexibleTopMargin|UIViewAutoresizingFlexibleRightMargin|UIViewAutoresizingFlexibleLeftMargin];
    ...
    // Outline.
    aButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [aButton setFrame:CGRectMake(side_b, viewSize.height-bot_b-offset, w, h)];
    im = [UIImage imageNamed:@"Menu.png"];
    [aButton setImage:im forState:UIControlStateNormal];
    [aButton setImageEdgeInsets:UIEdgeInsetsMake(0,0,0,0)];
    ...
    // Page label.
    UILabel *aLabel = [[UILabel alloc]initWithFrame:CGRectMake(padding, viewSize.height-padding-h, w, h)];
    ...
    //Page slider.
    UISlider *aSlider = [[UISlider alloc]initWithFrame:CGRectMake(padding*8, viewSize.height-padding-h,self.view.frame.size.width-w-40, h)];
